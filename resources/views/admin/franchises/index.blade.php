        ...
        <div @click.away="closeModal()" class="bg-gray-900 border border-[#9D00FF]/50 rounded-2xl shadow-[0_0_30px_rgba(157,0,255,0.2)] w-full max-w-md overflow-hidden" x-transition.scale>
            ...
            <form :action="formAction" method="POST" class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama" x-model="formData.nama" required class="w-full bg-black border border-gray-700 text-white rounded-lg px-4 py-3 focus:outline-none focus:border-[#9D00FF] focus:ring-1 focus:ring-[#9D00FF] transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.6)]" placeholder="Contoh: Naruto">
                </div>
